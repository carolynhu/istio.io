...
proxy. In the default configuration of Istio {{< istio_release_name >}}, the two proxies adds about 3.5 ms and 4.1ms to the 90th and 99th percentile latency separately of the data plane over the baseline.
...
- `none-both` Same as **both-sidecars** without Mixer.
